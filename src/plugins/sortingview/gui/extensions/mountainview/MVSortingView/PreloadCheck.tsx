...
const PreloadCheck: FunctionComponent<Props> = ({ recording, sorting, children, width, height, snippetLen }) => {
    ...
    const {task: preloadExtractSnippetsTask} = usePureCalculationTask<string>((recordingObject && sortingObject) ? sortingviewTaskFunctionIds.preloadExtractSnippets : undefined, {recording_object: recordingObject, sorting_object: sortingObject, snipets_len: snippetLen}, {})
