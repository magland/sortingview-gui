...
const UnitsTable: FunctionComponent<Props> = (props) => {
    ...
    const {returnValue: externalUnitMetrics} = usePureCalculationTask<ExternalSortingUnitMetric[]>(unitMetricsUri ? sortingviewTaskFunctionIds.fetchUnitMetrics : undefined, {unit_metrics_uri: unitMetricsUri || ''}, {})
